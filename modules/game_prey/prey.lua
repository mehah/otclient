...
function onPreyActive(slot, currentHolderName, currentHolderOutfit, bonusType, bonusValue, bonusGrade, timeLeft, timeUntilFreeReroll, wildcards) -- locktype always 0 for protocols <12
  local tracker = preyTracker.contentsPanel["slot"..(slot + 1)]
