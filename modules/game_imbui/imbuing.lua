...
function init()
  self.window = g_ui.displayUI('imbuing')
  self:hide()
...
function Imbuement.onOpenImbuementWindow()
  ...
  if player then
    ...
    self.window.contentPanel.gold.text:setText(comma_value(totalGold))
  end
...
function Imbuement.onSelectScroll()
  -- Enviar requisicao ao servidor para abrir janela de scroll
