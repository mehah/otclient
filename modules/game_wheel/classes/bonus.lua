...
function getPassiveInfo(domain)
	...
	if domain == 1 then
		...
		m2 = "Survive fatal attacks if overkill < 20%/25%/30% of max HP.\nHeal for 20%/25%/30% of max HP.\nReduce all cooldowns by 60s.\nCooldown: 30h/20h/10h"
	elseif domain == 2 then
		if vocation == KNIGHT then
		...
		elseif vocation == SORCERER then
			...
			m2 = "Beam spell deals death damage.\nCooldown: 10/8/6 seconds\nReduce other cooldowns by 1s per hit (max 3s).\nIncrease beam damage by 10%/12%/14% (max 30%/36%/42%)."
		elseif vocation == DRUID then
		...
		elseif vocation == MONK then
			...
			-- Default case for unknown vocation
			m1 = "Revelation Mastery\nBoosts your spells and abilities\nbased on your vocation."
			m2 = message
		end
	elseif domain == 3 then
		if vocation == KNIGHT then
		...
		elseif vocation == SORCERER then
			...
			m2 = "Expose Weakness: 1%/2%/3% mana leech\nSap Strength: 3%/4%/5% life leech\nAgainst debuffed creatures."
		elseif vocation == DRUID then
	...
	elseif domain == 4 then
		if vocation == KNIGHT then
			...
			m2 = "This spell transforms yourself into a powerful avatar for 15 seconds.\n\nWhile in this form, you benefit from 5%/10%/15% damage reduction and all your attacks are critical hits with 5%/10%/15% critical extra damage.\n\nCooldown: 120/90/60 minutes"
		elseif vocation == PALADIN then
			m1 = "Avatar of Light\nTransforms you into a\npowerful form that reduces\ndamage taken and increases\ndamage dealt."
			m2 = "This spell transforms yourself into a powerful avatar for 15 seconds.\n\nWhile in this form, you benefit from 5%/10%/15% damage reduction and all your attacks are critical hits with 5%/10%/15% critical extra damage.\n\nCooldown: 120/90/60 minutes"
		elseif vocation == SORCERER then
			m1 = "Avatar of Storm\nTransforms you into a\npowerful form that reduces\ndamage taken and increases\ndamage dealt."
			m2 = "Transform for 15 seconds.\n5%/10%/15% damage reduction.\nAll attacks are critical hits.\n5%/10%/15% critical extra damage.\nCooldown: 120/90/60 minutes"
		elseif vocation == DRUID then
			m1 = "Avatar of Nature\nTransforms you into a\npowerful form that reduces\ndamage taken and increases\ndamage dealt."
			m2 = "This spell transforms yourself into a powerful avatar for 15 seconds.\n\nWhile in this form, you benefit from 5%/10%/15% damage reduction and all your attacks are critical hits with 5%/10%/15% critical extra damage.\n\nCooldown: 120/90/60 minutes"
		elseif vocation == MONK then
