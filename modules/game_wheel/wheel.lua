...
function init()
  ...
  -- Add wheel button to main panel
  if modules.game_mainpanel then
    wheelButton = modules.game_mainpanel.addToggleButton('wheelButton', tr('Wheel of Destiny'), '/images/skillWheel', toggle, false, 16)
...
function onGameEnd()
  ...
  -- g_ui.setInputLockWidget(nil) -- Function not available
end

function show()
  g_game.requestResource(ResourceTypes.BANK_BALANCE)
  g_game.requestResource(ResourceTypes.GOLD_EQUIPPED)
  g_game.requestResource(ResourceWheelPoints)
  g_game.requestResource(ResourceTypes.LESSER_GEMS)
  g_game.requestResource(ResourceTypes.REGULAR_GEMS)
  g_game.requestResource(ResourceTypes.GREATER_GEMS)
  g_game.requestResource(ResourceTypes.LESSER_FRAGMENT)
  g_game.requestResource(ResourceTypes.GREATER_FRAGMENT)
  g_game.sendOpenDestinyWheel(g_game.getLocalPlayer():getId())
end
...
function onResourceBalance()
  ...
  -- Use available ResourceTypes instead of undefined constants
  ...
  -- Use ResourceTypes for fragments
