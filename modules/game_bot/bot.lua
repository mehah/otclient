...
function init()
  ...
  botButton = modules.client_topmenu.addLeftToggleButton('botButton', tr('Bot'), '/images/topbuttons/bot', toggle, false, 99999)
...
function clear()
 ...
 g_game.enableTileThingLuaCallback(false)
  ...
  for _, widget in pairs({modules.game_interface.getRightPanel(), modules.game_interface.getRightPanel()}) do
...
function refresh()
  ...
  local index = "Rodney Hayden" .. "_" .. g_game.getClientVersion()
